...
import com.psutools.reminder.ui.presentation.list.trip.TripDataListUiMapper
...
@HiltViewModel
class RoutesDataListViewModel @Inject constructor(
    ...
    private val _state: MutableStateFlow<ScreenState<RoutesDataListState>> = MutableStateFlow(
        ScreenState.Loading)
    ...
    private companion object {
        const val TAG = "RoutesDataListViewModel"
    }
}